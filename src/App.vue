          ...
          <div class="relative flex items-center justify-between h-16">
            ...
            <div class="flex-1 flex justify-center lg:justify-end">
              <div class="w-full px-2 lg:px-6">
                ...
                <div
                  class="relative text-indigo-300 focus-within:text-gray-400"
                >
                  <div
        ...
        <div class="flex-1 min-w-0 bg-white xl:flex xl:pl-8">
          ...
          <div class="bg-white lg:min-w-0 lg:flex-1">
            ...
            <div>
              ...
              >
                <li v-for="project in projects" :key="project" class="">
                  <div
            ...
            <div>
              ...
              <div>
                <ul class="divide-y divide-gray-200">
                  <li v-for="item in activityItems" :key="item" class="py-4">
